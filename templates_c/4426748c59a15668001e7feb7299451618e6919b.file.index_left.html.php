...
<dl>
  <dt onclick="javascript:show(this);">管理员账户</dt>
  <dd><a href="<?php echo $_smarty_tpl->tpl_vars['adminroot']->value;?>
/user/adminpage.php?page=list" target="mainFrame">用户管理</a></dd>
  <dd><a href="<?php echo $_smarty_tpl->tpl_vars['adminroot']->value;?>
/user/adminpage.php?page=add" target="mainFrame">用户添加</a></dd>
  <dd><a href="<?php echo $_smarty_tpl->tpl_vars['adminroot']->value;?>
/user/adminpage.php?page=pwd" target="mainFrame">密码修改</a></dd>
</dl>
<dl>
